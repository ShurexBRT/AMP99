...
- App version: **0.2.0-alpha.4**
- Phase: **closed alpha / physical QA**
- MSIX numeric package version: **0.2.0.4**
- Installer release: [`v0.2.0-alpha.4`](https://github.com/ShurexBRT/AMP99/releases/tag/v0.2.0-alpha.4)

...
- App version: **0.2.0-alpha.13**
- Phase: **closed alpha / physical QA**
- MSIX numeric package version: **0.2.0.13**
- Installer release: [`v0.2.0-alpha.13`](https://github.com/ShurexBRT/AMP99/releases/tag/v0.2.0-alpha.13)

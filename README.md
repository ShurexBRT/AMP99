...
- App version: **0.2.0-alpha.14**
- Phase: **closed alpha / physical QA**
- MSIX numeric package version: **0.2.0.14**
- Installer release: [`v0.2.0-alpha.14`](https://github.com/ShurexBRT/AMP99/releases/tag/v0.2.0-alpha.14)
